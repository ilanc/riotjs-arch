...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__testbox_tag_html__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__testbox_tag_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__testbox_tag_html__);

    var riot = __webpack_require__(0)
    //src: src/test/app.tag.html

riot.tag2('app',
  '<testbox></testbox> <br> <testbox text="some text"></testbox> <br> <testbox text="{box3}"></testbox> <br>',
  '',
  '', function(opts) {
    console.log('app.tag')
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var riot = __webpack_require__(0)
    //src: src/test/testbox.tag.html
riot.tag2('testbox',
  '<div>{text}</div>',
  'testbox div,[data-is="testbox"] div{ width: 100px; height: 100px; background-color: red; }',
  '', function(opts) {
		console.log('testbox.tag.html')
